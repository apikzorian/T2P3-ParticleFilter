...
int main() {
	...
	// Read map data
	Map map;
	if (!read_map_data("C://Users//apik//CarND//CarND-Kidnapped-Vehicle-Project-master2//data//map_data.txt", map)) {
	...
	if (!read_control_data("C://Users//apik//CarND//CarND-Kidnapped-Vehicle-Project-master2//data//control_data.txt", position_meas)) {
	...
	if (!read_gt_data("C://Users//apik//CarND//CarND-Kidnapped-Vehicle-Project-master2//data//gt_data.txt", gt)) {
	...
	for (int i = 0; i < num_time_steps; ++i) {
		...
		ostringstream file;
		file << "C://Users//apik//CarND//CarND-Kidnapped-Vehicle-Project-master2//data//observation//observations_" << setfill('0') << setw(6) << i+1 << ".txt";
